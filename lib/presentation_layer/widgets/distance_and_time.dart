...
class DistanceAndTime extends StatelessWidget {
  ...
  const DistanceAndTime({Key? key,this.placeDirections,required this.isTimeAndDistanceVisible}) : super(key: key);
            ...
            Flexible(
              ...
              child: Card(
                ...
                child: ListTile(
                  ...
                  leading: Icon(Icons.access_time_filled,color: MyColors.blue,size: 30,),
                  title: Text(
            ...
            Flexible(
              ...
              child: Card(
                ...
                child: ListTile(
                  dense: true,
                  horizontalTitleGap: 0,
                  leading: Icon(Icons.directions_car_filled,color: MyColors.blue,size: 30,),
                  title: Text(
